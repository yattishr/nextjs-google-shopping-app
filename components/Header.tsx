  ...
  return (
    <header className="flex flex-col items-center md:flex-row md:items-start md:space-x-6 px-2 pt-10 pb-5 md:p-10 md:pb-5">
      ...
      <div className="w-full md:max-w-2xl">
        <form
          action={(formData) => {
            ...
            console.log(`Logging searchTerm...${searchTerm}`)
            router.push(`/search/${searchTerm}?${params.toString()}`);
          }}
        >
          <div className="flex items-center gap-2 w-full px-4">
            <div className="flex items-center space-x-2 bg-white shadow-xl rounded-full border-2 px-6 py-4 md:max-w-5xl flex-1">
      ...
      <div className="hidden lg:flex flex-1 justify-end">
        {/* Avatar */}
        <Avatar
          name="Yattish Ramhorry"
          instagramId="yattishr"
          round
          size="50"
        />
      </div>
